...
<html>
    ...
    <center>
        <table>
            <tr>
                <td>
                    <img style="float:left;" height="70px"src="../Database/Images/Foundation/<?php echo $foundationdata[1] ?>"/>
                    <p style="float:left;" ><font size="5"><?php echo $foundationdata[0]; ?></font></p>
                </td>
            </tr>
        </table>
    </center>
