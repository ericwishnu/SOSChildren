...
class KidsCtrl {
    ...
    private function deleteKid() {
        $username = $_POST['kidSelected'];
        $this->kids_db_class->deletekid_db($username);
        $this->listKids();
    }
