...
<html>
    ...
    <body>
        ...
        <form action='KidsCtrl.php' method="post">
            ...
            <?
            $kidsData = new Kids(
                    unserialize($_SESSION['kidsdataobj'])->getKidsID(), unserialize($_SESSION['kidsdataobj'])->getName(), unserialize($_SESSION['kidsdataobj'])->getPhoto(), unserialize($_SESSION['kidsdataobj'])->getDOB(), unserialize($_SESSION['kidsdataobj'])->getBackground(), unserialize($_SESSION['kidsdataobj'])->getRegion(), unserialize($_SESSION['kidsdataobj'])->getOrigin(), unserialize($_SESSION['kidsdataobj'])->getAspiration(), unserialize($_SESSION['kidsdataobj'])->getHealth(), unserialize($_SESSION['kidsdataobj'])->getEducation(), unserialize($_SESSION['kidsdataobj'])->getNutrition(), unserialize($_SESSION['kidsdataobj'])->getFoundationID(), unserialize($_SESSION['kidsdataobj'])->getKidsIDinFoundation()
            );
            ?>  
            <br/><br/>
            <table frame="box" style="solid" width="848"><!-- TABLE AFTER FIRST TABLE -->
                <tr>
                    <td valign="top" frame="box"align="center" rowspan="7" width="200px">
                        ...
                        if (isset($_SESSION['usernameU']) && $_SESSION['usernameU'] != "") {
                            if (isset($_SESSION['checkFoster']) && $_SESSION['checkFoster'] == "false") {
                                ?>
                                <input type="submit" value="Foster Me">
